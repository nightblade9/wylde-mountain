...
dotnet sonarscanner begin /key:"HydraPeak" /d:sonar.cs.opencover.reportsPaths=HydraPeak.Web.Tests/coverage.opencover.xml /d:sonar.coverage.exclusions="**Test*.cs","**/*.test*.tsx"
